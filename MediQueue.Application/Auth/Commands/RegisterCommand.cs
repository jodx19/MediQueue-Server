...
public class RegisterCommandValidator : AbstractValidator<RegisterCommand>
{
    public RegisterCommandValidator()
    {
        ...
        RuleFor(x => x.DateOfBirth)
            ...
            .When(x => string.Equals(x.Role, "Patient", StringComparison.OrdinalIgnoreCase));

        RuleFor(x => x.NationalId)
            .NotEmpty()
            .MinimumLength(5)
            .WithMessage("National ID is required for patient registration.")
            .When(x => string.Equals(x.Role, "Patient", StringComparison.OrdinalIgnoreCase));
    }
}
        ...
        try
        {
            await _unitOfWork.ExecuteStrategyAsync(async () =>
            {
                ...
                try
                {
                    ...
                    {
                        // DateOfBirth and NationalId are validated as required above
                        ...
                        var patient = Patient.Register(
                            personName,
                            request.DateOfBirth!.Value,   // validated non-null by FluentValidation
                            Gender.Other,
                            BloodType.Unknown,
                            request.NationalId!,          // validated non-null by FluentValidation
                            contactInfo,
                            new Address("Unknown", "Unknown", "Unknown"),
                            MaritalStatus.Single);
                        // MRN is auto-generated by Patient.GenerateMRN() inside the domain
